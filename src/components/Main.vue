    ...
    <!--侧边栏菜单区域-->
      <el-aside width="300px">
        <el-menu
          ...
          <!--一级菜单--><!--超级管理员-->
          <el-submenu index="1" v-if="department">
            <!--一级菜单模板区域-->
            <template slot="title">
          ...
          <!--实验技术员-->
          <el-submenu index="2" v-if="artisan">
            <template slot="title">
              <i class="el-icon-location"></i>
              <span>助理招聘</span>
            </template>
          ...
          <!--部门-->
          <el-submenu index="5" v-if="department">
            <template slot="title">
              <i class="el-icon-location"></i>
              <span>专业技术实验室</span>
            </template>
          ...
          <!--系统用户-->
          <el-submenu index="6" v-if="systemUser">
            <template slot="title">
              <i class="el-icon-location"></i>
              <span>招聘信息</span>
            </template>
          ...
          <!--学生助理-->
          <el-submenu index="7" v-if="assistant">
            <template slot="title">
              <i class="el-icon-location"></i>
              <span>工作内容</span>
            </template>
