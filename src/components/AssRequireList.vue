<template>
  <div>
    <div class="list_title">
      ...
      <el-button type="warning" @click="requireDelete" round>删除</el-button>
      <template>
        <el-table
          :data="tableData"
          border
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span  v-if="scope.row.repairStatus==='0'" >未修</span>
              <tag class="small"><span v-if="scope.row.repairStatus==='1'">已修</span></tag>
            </template>
          </el-table-column>
          <el-table-column
            fixed="right"
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      console.log(account)
      const url = `http://localhost:8181/repair/findByStuId/1/6/` + account.username
